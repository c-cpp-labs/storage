...
Здесь вам предстоит окунуться в мир орков (а если быть точнее, то создать его). Здесь нет места слабости и малодушию. Гнев, слезы, разочарования - это лишь малая часть эмоций, которые вас поджидают вас при выполнении данного проекта. Уровень сложности - `мегахард`. Погнали)
...
- у бойцов имеются следующие атрибуты:
  ...
  - тип брони, её состояние (если воин)
  - мана (mp, если маг)
